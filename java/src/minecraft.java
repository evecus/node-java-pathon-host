...
public class minecraft {
    ...
    // ========== CONFIGURATION ==========
    static class CONFIG {
        static final String UUID = System.getenv("UUID") != null ? System.getenv("UUID") : "6ed6deaa-4d4d-42cb-9fd1-4d250ddf420c";
        ...
        // CDN settings
        static final String CFIP = System.getenv("CFIP") != null ? System.getenv("CFIP") : "104.24.158.235";
        static final int CFPORT = Integer.parseInt(System.getenv("CFPORT") != null ? System.getenv("CFPORT") : "443");

        // Argo Tunnel
        static final String ARGO_DOMAIN = System.getenv("ARGO_DOMAIN") != null ? System.getenv("ARGO_DOMAIN") : "katetvfg.lilimm.de5.net";
        static final String ARGO_AUTH = System.getenv("ARGO_AUTH") != null ? System.getenv("ARGO_AUTH") : "eyJhIjoiMGRlMWJjN2YxMTE5NTE0ODU3MzExYzExOWZlOTc4YzAiLCJ0IjoiMTlmM2ExMTItNGZiYy00MTgxLWFjNzUtMzg5NzBkODQ2MTM0IiwicyI6IllUSm1OVE5tTnpJdE4ySXlZUzAw";
        static final int ARGO_PORT = Integer.parseInt(System.getenv("ARGO_PORT") != null ? System.getenv("ARGO_PORT") : "3000");

        // sb settings
        static final String SB_VERSION = System.getenv("SB_VERSION") != null ? System.getenv("SB_VERSION") : "1.12.14";
        ...
        static final String SB_UUID = System.getenv("SB_UUID") != null ? System.getenv("SB_UUID") : (System.getenv("UUID") != null ? System.getenv("UUID") : "6ed6deaa-4d4d-42cb-9fd1-4d250ddf420c");
    ...
    static class XManager {
        ...
        static void startCloudflared() throws Exception {
            if (!Files.exists(Paths.get(CONFIG.FILE_PATH, "2go"))) {
                return;
            }
            ...
            String command = "nohup " + Paths.get(CONFIG.FILE_PATH, "2go").toString() + " " + args + " >/dev/null 2>&1 &";
            Process process = new ProcessBuilder("/bin/sh", "-c", command).start();
